...
const TeamMemberCard = (props) => {
  return (
    <div className=" w-60 m-2 h-90 bg-[#193e65] pb-2 rounded-lg relative group">
      ...
      <div className=" h-44 p-4 text-white relative ">
        <div>
          ...
          <div className=" relative p-1 ">
            <h3 className=" text-xs pb-1 font-medium opacity-50">
              {props.deg}
            </h3>
            <hr></hr>

            <p className=" text-xs  pt-1 opacity-70">{props.experience}</p>
