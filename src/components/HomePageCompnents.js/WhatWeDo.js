...
const WhatWeDo = () => {
  ...
  return (
    ...
    >
      <div className="w-full h-full md:w-2/3 lg:w-1/2 xl:w-1/3 p-4 mx-5">
        <img
      ...
      <div className="w-full md:w-1/2 lg:w-2/3 xl:w-2/3 p-4 mx-5">
        <h1 className="font-adventPro text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
          What We Do
        </h1>
        <p className="text-[#FFFFFF] font-adventPro text-base md:text-lg mt-5 md:mt-10">
